<template>
  <div :class="_isMobile?'side-bar':'side-bar-m'">
...
.side-bar .auther-info-2 :last-child {
...
.side-bar .lasted-content-main li {
  /* background: blue; */
  white-space: nowrap;
...
.side-bar .auther-reply-content li {
  /* background: blue; */
  white-space: nowrap;
  text-overflow: ellipsis;
  overflow: hidden;
...
.side-bar-m .auther-info .auther-info-2{
  font-size: 3vw;
   color: rgba(112, 108, 108, 0.664);
}
.side-bar-m .lasted-content-main li{
      list-style-type: none;
    color: rgba(112, 108, 108, 0.664);
    font-size: 12px;
    margin: 10px 10px;
}
.side-bar-m .auther-reply-content li{
  list-style-type: none;
    color: rgba(112, 108, 108, 0.664);
    font-size: 12px;
    margin: 10px 10px;
